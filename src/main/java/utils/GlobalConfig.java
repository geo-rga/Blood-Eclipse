...
public class GlobalConfig {
	...
	// Android config - this has now been moved to AndroidCapabilities and android-device-config.json
	...
	// iOS config - this has now been moved to IOSCapabilities and ios-device-config.json
